...
impl<B: TryFromBody> TryNonRequestFromRequest for http::Request<B> {
    type Error = B::Error;
    fn try_from_request(req: Request) -> Result<Self, Self::Error> {
        let mut builder = http::Request::builder().uri(req.uri()).method(req.method);
...
impl From<super::Method> for http::Method {
    fn from(method: super::Method) -> Self {
        match method {
            super::Method::Get => http::Method::GET,
            super::Method::Post => http::Method::POST,
            super::Method::Put => http::Method::PUT,
            super::Method::Delete => http::Method::DELETE,
            super::Method::Patch => http::Method::PATCH,
            super::Method::Head => http::Method::HEAD,
            super::Method::Options => http::Method::OPTIONS,
            super::Method::Connect => http::Method::CONNECT,
            super::Method::Trace => http::Method::TRACE,
            super::Method::Other(o) => http::Method::from_bytes(o.as_bytes()).expect("TODO"),
        }
    }
}
impl From<http::Method> for super::Method {
    fn from(method: http::Method) -> Self {
        match method {
            http::Method::GET => super::Method::Get,
            http::Method::POST => super::Method::Post,
            http::Method::PUT => super::Method::Put,
            http::Method::DELETE => super::Method::Delete,
            http::Method::PATCH => super::Method::Patch,
            http::Method::HEAD => super::Method::Head,
            http::Method::OPTIONS => super::Method::Options,
            http::Method::CONNECT => super::Method::Connect,
            http::Method::TRACE => super::Method::Trace,
...
impl IntoHeaders for &http::HeaderMap {
    fn into_headers(self) -> Vec<(String, Vec<u8>)> {
        self.iter()
...
impl<B> TryIntoOutgoingRequest for http::Request<B>
where
    B: TryIntoBody,
    B::Error: std::error::Error + Send + Sync + 'static,
{
    ...
    fn try_into_outgoing_request(self) -> Result<(OutgoingRequest, Option<Vec<u8>>), Self::Error> {
        ...
        let scheme = self.uri().scheme().map(|s| match s.as_str() {
            "http_internal" => super::Scheme::Http,
...
#[async_trait]
impl<B: TryFromBody> TryFromIncomingResponse for http::Response<B> {
    type Error = B::Error;
    async fn try_from_incoming_response(resp: IncomingResponse) -> Result<Self, Self::Error> {
...
impl<B: TryIntoBody> TryIntoRequest for http::Request<B> {
    type Error = B::Error;
    fn try_into_request(self) -> Result<Request, Self::Error> {
        Ok(Request::builder()
