...
pub enum Error {
    ...
    FdNotFound { value: String },

    /// The requested model does not exist
    #[error("The model 'ml::{value}' does not exist")]
    MlNotFound { value: String },
    ...
    FieldReadonly { thing: String, field: Idiom },
    ...
    IndexAlreadyBuilding { index: String },
    ...
    InvalidRangeValue { expected: String, found: String },

    /// Found an unexpected value in a range
    #[error("The range cannot exceed a size of {max} for this operation")]
    RangeTooBig { max: usize },
    ...
    IdiomRecursionAlreadyRecursing { symbol: String },
...
impl Error {
    ...
    pub fn set_check_from_coerce(self, name: String) -> Error {
        match self {
            Error::CoerceTo { from, into } => Error::SetCheck {
                name,
    ...
    pub fn function_check_from_coerce(self, name: impl Into<String>) -> Error {
        match self {
            Error::CoerceTo { from, into } => Error::FunctionCheck {
                name: name.into(),
                value: from.to_string(),
                check: into,
            },
