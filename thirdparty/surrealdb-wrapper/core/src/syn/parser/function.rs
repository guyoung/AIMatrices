...
mod test {
    ...
    fn function_single() {
        ...
        assert_eq!(
            out,
            Value::from(Function::Normal(String::from("count"), vec![]))
        );
    }
    ...
    fn function_single_not() {
        ...
        assert_eq!(
            out,
            Value::from(Function::Normal("not".to_owned(), vec![10.into()]))
        );
    }
    ...
    fn function_module() {
        ...
        assert_eq!(
            out,
            Value::from(Function::Normal(String::from("rand::uuid"), vec![]))
        );
    }
    ...
    fn function_simple_together() {
        ...
        assert_eq!(
            out,
            Value::from(Function::Script(Script::from(" return 'test'; "), vec![]))
        );
    }
    ...
    fn script_basic() {
        ...
        assert_eq!(
            out,
            Value::from(Function::Script(Script::from("return true;"), Vec::new()))
        );
    }
    ...
    fn script_advanced() {
        ...
        assert_eq!(
            out,
            Value::from(Function::Script(Script::from(body), Vec::new()))
        );
    }
}
