...
pub enum InfoStatement {
    ...
    #[revision(
        override(revision = 2, discriminant = 1),
        override(revision = 3, discriminant = 1)
    )]
    Root(#[revision(start = 2)] bool),

    #[revision(
        override(revision = 2, discriminant = 3),
        override(revision = 3, discriminant = 3)
    )]
    Ns(#[revision(start = 2)] bool),

    #[revision(
        override(revision = 2, discriminant = 5),
        override(revision = 3, discriminant = 5)
    )]
    Db(
        #[revision(start = 2)] bool,
        #[revision(start = 5)] Option<Version>,
    ),

    #[revision(
        override(revision = 2, discriminant = 7),
        override(revision = 3, discriminant = 7)
    )]
    Tb(
        Ident,
        #[revision(start = 2)] bool,
    ...
    #[revision(
        override(revision = 2, discriminant = 9),
        override(revision = 3, discriminant = 9)
    )]
