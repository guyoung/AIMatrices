...
impl DocLengths {
    ...
    pub(super) async fn get_doc_length(
        ...
        self.btree
            .search(tx, &self.store, &doc_id.to_be_bytes().to_vec())
            .await
    }
    ...
    pub(super) async fn get_doc_length_mut(
        ...
        self.btree
            .search_mut(tx, &mut self.store, &doc_id.to_be_bytes().to_vec())
            .await
    }
    ...
    pub(super) async fn remove_doc_length(
        ...
        self.btree
            .delete(tx, &mut self.store, doc_id.to_be_bytes().to_vec())
            .await
    }
