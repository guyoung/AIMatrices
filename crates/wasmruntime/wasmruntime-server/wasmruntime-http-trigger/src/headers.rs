...
// modules is going to be different, so each executor must use the info
// in its standardized way (environment variables for the Wagi executor, and custom headers
// for the HTTP executor).
pub const FULL_URL: [&str; 2] = ["REQ_FULL_URL", "X_FULL_URL"];
pub const PATH_INFO: [&str; 2] = ["REQ_PATH_INFO", "PATH_INFO"];
pub const MATCHED_ROUTE: [&str; 2] = ["REQ_MATCHED_ROUTE", "X_MATCHED_ROUTE"];
pub const COMPONENT_ROUTE: [&str; 2] = ["REQ_COMPONENT_ROUTE", "X_COMPONENT_ROUTE"];
pub const RAW_COMPONENT_ROUTE: [&str; 2] = ["REQ_RAW_COMPONENT_ROUTE", "X_RAW_COMPONENT_ROUTE"];
pub const BASE_PATH: [&str; 2] = ["REQ_BASE_PATH", "X_BASE_PATH"];
pub const CLIENT_ADDR: [&str; 2] = ["REQ_CLIENT_ADDR", "X_CLIENT_ADDR"];
...
pub fn prepare_header_key(key: &str) -> String {
