...
pub static ROCKSDB_THREAD_COUNT: LazyLock<i32> =
    lazy_env_parse_or_else!("SURREAL_ROCKSDB_THREAD_COUNT", i32, |_| num_cpus::get()
        as i32);

pub static ROCKSDB_JOBS_COUNT: LazyLock<i32> =
    lazy_env_parse_or_else!("SURREAL_ROCKSDB_JOBS_COUNT", i32, |_| num_cpus::get()
        as i32
        * 2);

pub static ROCKSDB_WRITE_BUFFER_SIZE: LazyLock<usize> = lazy_env_parse!(
    "SURREAL_ROCKSDB_WRITE_BUFFER_SIZE",
    usize,
    256 * 1024 * 1024
);

pub static ROCKSDB_TARGET_FILE_SIZE_BASE: LazyLock<u64> = lazy_env_parse!(
...
pub static ROCKSDB_STORAGE_LOG_LEVEL: LazyLock<String> = lazy_env_parse!(
