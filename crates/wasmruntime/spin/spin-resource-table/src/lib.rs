...
/// This is a spin-resource-table for generating unique u32 identifiers for each element in a dynamically-changing set of
/// resources.
///
...
impl<V> Table<V> {
    /// Create a new, empty spin-resource-table with the specified capacity.
    ...
    /// Add the specified resource to this spin-resource-table.
    ///
    /// If the spin-resource-table is full (i.e. there already are `self.capacity` resources inside), this returns `Err(())`.
