...
pub enum Error {
    ...
    FromValue { value: Value, error: String },
...
#[cfg_attr(
    docsrs,
    doc(cfg(all(feature = "protocol-ws", not(target_arch = "wasm32"))))
)]
