        ...
        fn into_future(self) -> Self::IntoFuture {
            ...
            Box::pin(async move {
                let (table, data) = match resource? {
                    ...
                    Resource::Edge { .. } => return Err(Error::InsertOnEdges.into()),
                    Resource::Range { .. } => return Err(Error::InsertOnRange.into()),
        ...
        D: Serialize + 'static,
    {
        Content::from_closure(self.client, || {
            ...
            match self.resource? {
                ...
                Resource::Unspecified => Ok(Command::Insert { what: None, data }),
            }
        })
    }
}
        ...
        D: Serialize + 'static,
    {
        InsertRelation::from_closure(self.client, || {
            ...
            match self.resource? {
                ...
                Resource::Unspecified => Ok(Command::InsertRelation { what: None, data }),
                Resource::Object(_) => Err(Error::InsertOnObject.into()),
                Resource::Array(_) => Err(Error::InsertOnArray.into()),
                Resource::Edge(_) => Err(Error::InsertOnEdges.into()),
                Resource::Range(_) => Err(Error::InsertOnRange.into()),
